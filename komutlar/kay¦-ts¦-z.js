...
message.channel.send(new MessageEmbed().setDescription(`${member} Adlı kullanıcı ${message.author} tarafından kayıtsıza atıldı! | <@&saykayıtsızid>`).setFooter("Abey 🖤 was here")).then(msg => msg.delete({timeout: 4000}))
